...
mkdir -p /data/rgd-knowledge-graph/pubtator3/local/aioner
...
mkdir -p /data/rgd-knowledge-graph/pubtator3/local/taggerone-cellline
...
mkdir -p /data/rgd-knowledge-graph/pubtator3/local/taggerone-disease
...
mkdir -p /data/rgd-knowledge-graph/pubtator3/local/gnorm2
...
mkdir -p /data/rgd-knowledge-graph/pubtator3/local/nlmchem
...
mkdir -p /data/rgd-knowledge-graph/pubtator3/local/biorex
